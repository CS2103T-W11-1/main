...
** What it does: allows the user to navigate to previous commands using kbd:[Ctrl + ↑] and kbd:[Ctrl + ↓] keyboard shortcut.

** Justification: This feature makes `addfindrule` more useful - the user can first check if their problem find rule is working as expected by executing it using `find` command, then press kbd:[Ctrl + ↑] to restore the command text, change the command word to `addfindrule` and assign a name to the added find rule.

** Relevant pull request
https://github.com/AY1920S1-CS2103T-W11-1/main/pull/105[#105]
https://github.com/AY1920S1-CS2103T-W11-1/main/pull/137[#137]
...
** Community:
*** As shown below, I participated in the review of most significant PRs in *AlgoBase* to make sure that the code quality of this project is consistent.
